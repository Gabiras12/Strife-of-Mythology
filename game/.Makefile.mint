...
INCLUDES = -Iinclude `sdl2-config --cflags` -I/usr/local/include/ijengine -I/usr/include/lua5.2
LIBS =  -L/usr/local/lib -lijengine `sdl2-config --libs` -lSDL2_image -lSDL2_ttf -lSDL2_mixer -ldl -llua5.2
