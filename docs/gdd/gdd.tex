...
O \textit{Front End} do jogo terá  cinco telas principais, sendo elas, menu de \textit{Abertura}, \textit{Gameplay} e \textit{Créditos}, uma quarta tela de vitoria e a quinta tela de game over. A seguir uma representação das telas do jogo.
